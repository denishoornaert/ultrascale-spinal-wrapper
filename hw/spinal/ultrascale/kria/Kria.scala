...
//    KriaPorts.setAceInterfaceAttributes(io.fpd_ace)
  ...
  ConfigPorts.build(KriaPorts.LPD_HPM0_Config)
  io.lpd_hpm0 <> ConfigPorts.port.io.axi
...
object KriaVerilog extends App {
  ...
  Config.spinal.generateVerilog(Kria(withLPD_HPM0=true, withCross_Trigger_Input=2, withCross_Trigger_Output=2, withPMOD=8))
}
