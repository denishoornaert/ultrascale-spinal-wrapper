...
class Axi4Mapped(override val config: Axi4Config, name: String, val apertures: Seq[Aperture], id: Int, domain: String) extends Axi4(config) with PSPLInterface with TCL {
